...
final class AnimatedCrossFadeExample extends StatefulWidget {
  final Widget firstChild;
  final Widget secondChild;
  const AnimatedCrossFadeExample({super.key, required this.firstChild, required this.secondChild});
  @override
