...
import 'package:unipool/features/overlay/controller/indicator_controller.dart';
import 'package:unipool/features/overlay/controller/indicator_painter.dart';
...
class _BallRotateState extends State<BallRotate> with SingleTickerProviderStateMixin, IndicatorController {
  ...
  void initState() {
    ...
    _rotateAnimation = Tween(begin: 0.0, end: 1.0).animate(CurvedAnimation(parent: _animationController, curve: cubic));
